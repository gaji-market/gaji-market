...
**`가지마켓`은 중고거래 웹 플랫폼으로 당근마켓의 기능을 오마주한 프로젝트입니다. <br/>**
사용자가 판매/구매할 물품을 등록하고 등록한 물품을 검색할 수 있으며, <br/>
판매자와 구매자는 채팅을 통해 중고거래를 진행할 수 있습니다. <br/>

-- --

## 배포 사이트
[가지마켓](http://gajimarket.shop.s3-website.ap-northeast-2.amazonaws.com/)
...
`Frontend`  <br/><br/>
<img src="https://img.shields.io/badge/React-61DAFB?logo=React&logoColor=white" /> <img src="https://img.shields.io/badge/Redux Toolkit-%23593d88?logo=redux&logoColor=white" /> <img src="https://img.shields.io/badge/StyledComponents-DB7093?logo=styledcomponents&logoColor=white" /> 
 <img src="https://img.shields.io/badge/Sass-CC6699?style=flat-round&logo=Sass&logoColor=white"/> <br/>
<img src="https://img.shields.io/badge/Figma-%23F24E1E.svg?logo=Figma&logoColor=white"/><br/>
<img src="https://img.shields.io/badge/Amazon_S3-569A31?logo=AmazonS3&logoColor=white"/>

<br/>

`Backend` <br/><br/>
<img src="https://img.shields.io/badge/Spring-6DB33F?logo=spring&logoColor=white"> <img src="https://img.shields.io/badge/MySql-4479A1?logo=mysql&logoColor=white"><br/>
<img src="https://img.shields.io/badge/Socket.Io-010101?logo=socket.io&logoColor=white"><br/>
...
살래요, 팔래요 페이지는 메인 페이지 또는 상단 앱 바의 토글을 통해 이동이 가능하며 `무한 스크롤`로 구현하였습니다.<br/>
UX를 고려하여 사용자가 로딩 중임을 확인할 수 있도록 스켈레톤 카드를 사용하였습니다. 
...
아이디를 6글자 이상 입력하게 되면 아이디 검사를 할 수 있는 버튼이 나오고<br/> API 통신을 통해서 현재 가입되어 있는 아이디 인지 확인합니다.<br/>
...
아이디 찾기는 회원의 이름과 생년월일을 검색하면<br/> 해당 정보의 아이디를 서버에서 받아서 보여주는 형식으로 구현하였습니다. <br/>
비밀번호 변경은 아이디,이름,생년월일을 입력했을 때<br/> 모두 일치하는 정보를 가진 아이디의 비밀번호를 바꾸는 형식으로 구현하였습니다.<br/>
...
### ⚛ 회원간 채팅 기능
현재 구매/판매 중의 사용자와 채팅이 가능하도록 구현하였습니다. <br/>

![Honeycam 2023-04-26 03-46-51](https://user-images.githubusercontent.com/48672106/234373673-cca6c599-b474-4720-a123-51158ded3fd4.gif)
...
| 이름   | 역할 | 담당 부분                                                                                                                                                                                            |
|:---:|---| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [강지수](https://github.com/Jisu-kkk) | BE   | -                                                                                                               |
...
![image](https://user-images.githubusercontent.com/48672106/234371762-c3806aba-f2af-478b-bf4f-31bb958caf5e.png)


<br/>

## [🍆가지마켓 프로젝트 문서(노션)](https://shared-psy-world.notion.site/169eea853e7a42aa9dcd4dac25887870)
