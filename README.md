...
| 강지수 | BE   | 1. -                                                                                                               |
| 유희주 | BE   | 1. -                                                              |
| 임건형 | BE   | 1. 상품(살래요/팔래요) CRUD 기능 <br> 2. 상품 좋아요 기능 <br> 3. 하위메뉴 카테고리 기능 <br> 4. 상품 검색 기능 <br> 5. aws ec2 백서버 배포 <br> 6. aws s3 파일 업로드 기능|
| 박선영 | FE   | 1. -                                  |
| 이유   | FE   | 1. 상품 전체보기 페이지(살래요/팔래요) 구현 <br> 2. 상품 디테일 페이지(살래요/팔래요) 구현 <br> 3. 상품 등록 에디터 구현 <br> 4. UI/UX 및 로고 디자인 <br/>                                                                    |
| 홍주완 | FE   | 1. 로그인 구현 <br> 2. 회원가입 구현 <br> 3. 마이페이지 구현 <br> 4. 토스트창 구현  <br> 5. aws s3 를 이용한 프론트 배포                                                                                                                 |
## 🍆 커밋 컨벤션
